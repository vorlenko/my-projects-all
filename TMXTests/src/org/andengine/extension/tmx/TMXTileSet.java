...
public class TMXTileSet implements TMXConstants {
	...
	public void setImageSource(final Context pContext, final TextureManager pTextureManager, final Attributes pAttributes, String pAssetBasePath) throws TMXParseException {
		this.mImageSource = pAssetBasePath + pAttributes.getValue("", TAG_IMAGE_ATTRIBUTE_SOURCE);
