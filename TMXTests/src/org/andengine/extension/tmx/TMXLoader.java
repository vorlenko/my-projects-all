...
public class TMXLoader {
	...
	/** absolute path for asset, must ends with '/' */
	...
	public TMXLoader(final Context pContext, final TextureManager pTextureManager, final String pAssetBasePath) {
		this(pContext, pTextureManager, TextureOptions.DEFAULT, null, pAssetBasePath);
	}
	...
	public TMXLoader(final Context pContext, final TextureManager pTextureManager, final TextureOptions pTextureOptions, final String pAssetBasePath) {
		this(pContext, pTextureManager, pTextureOptions, null, pAssetBasePath);
	}
	...
	public TMXLoader(final Context pContext, final TextureManager pTextureManager, final ITMXTilePropertiesListener pTMXTilePropertyListener, final String pAssetBasePath) {
		this(pContext, pTextureManager, TextureOptions.DEFAULT, pTMXTilePropertyListener, pAssetBasePath);
	}

	public TMXLoader(final Context pContext, final TextureManager pTextureManager, final TextureOptions pTextureOptions, final ITMXTilePropertiesListener pTMXTilePropertyListener, final String pAssetBasePath) {
	...
	public TMXTiledMap loadFromAsset(final Context pContext, final String pAssetPath) throws TMXLoadException {
		try {
			return this.load(pContext.getAssets().open(mAssetBasePath + pAssetPath));
	...
	public TMXTiledMap load(final InputStream pInputStream) throws TMXLoadException {
		try{
			...
			final TMXParser tmxParser = new TMXParser(this.mContext, this.mTextureManager, this.mTextureOptions, this.mTMXTilePropertyListener, mAssetBasePath);
