...
public class TSXParser extends DefaultHandler implements TMXConstants {
	...
	public TSXParser(final Context pContext, final TextureManager pTextureManager, final TextureOptions pTextureOptions, final int pFirstGlobalTileID, String mAssetBasePath) {
	...
	public void startElement(final String pUri, final String pLocalName, final String pQualifiedName, final Attributes pAttributes) throws SAXException {
		if(pLocalName.equals(TMXConstants.TAG_TILESET)){
			...
			this.mInImage = true;
			this.mTMXTileSet.setImageSource(this.mContext, this.mTextureManager, pAttributes, mAssetBasePath);
